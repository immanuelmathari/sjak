...
const accordionData = [
  {
    title: "Why BLS Training is Important",
    content:
      "Cardiac and respiratory emergencies can happen anywhere — at home, at work, or in public spaces. Immediate response through basic life support significantly increases the chances of survival. BLS training equips individuals with the skills to act quickly, confidently, and correctly in those critical first moments.",
  },
  {
    title: "Who Should Attend",
    content:
      "This course is suitable for healthcare providers, first responders, teachers, gym instructors, caregivers, corporate staff, and members of the public. It is especially valuable for anyone responsible for the safety and wellbeing of others.",
  },
  {
    title: "What You Will Learn",
    content:
      "Participants will learn CPR techniques for adults, children, and infants, how to use an AED, how to manage choking incidents, and how to assess and respond to life-threatening emergencies. The training focuses on simple, effective actions that can be applied immediately.",
  },
  {
    title: "Course Duration and Structure",
    content:
      "The Basic Life Support Course is typically conducted over one day. It combines short theoretical sessions with intensive hands-on practice to ensure participants fully understand and can perform life-saving techniques with confidence.",
  },
  {
    title: "How to Respond in a Life-Threatening Emergency",
    content:
      "Participants are trained to follow a structured approach: assess the scene for safety, check responsiveness and breathing, call for help, begin CPR, and use an AED if available. Emphasis is placed on speed, accuracy, and maintaining composure under pressure.",
  },
  {
    title: "Benefits for Individuals and Organisations",
    content:
      "For individuals, BLS training builds confidence and equips them with the ability to save lives in emergencies. For organisations, it enhances workplace safety, reduces risks, and ensures staff are prepared to respond effectively, demonstrating a strong commitment to health and safety.",
  },
  {
    title: "Why You Should Choose St John Ambulance Kenya",
    content:
      "St John Ambulance Kenya is a trusted leader in first aid and emergency training with a long-standing reputation for excellence. Our instructors are highly qualified, and our training is practical, engaging, and aligned with international standards. Choosing St John ensures you receive quality training that prepares you for real-life emergencies.",
  },
];
...
Basic Life Support (BLS) Course With St John Ambulance Kenya
</h1>
...
<section className="bg-white dark:bg-black py-12 md:py-20">
  <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
   ...
   <p>
  The Basic Life Support (BLS) Course offered by St John Ambulance Kenya is a foundational life-saving programme designed to equip individuals with the essential skills needed to respond to cardiac and breathing emergencies.
</p>

<p>
  In critical situations such as cardiac arrest, choking, or respiratory failure, immediate action can mean the difference between life and death. BLS training focuses on early recognition and rapid response, empowering participants to provide effective care before advanced medical help arrives.
</p>

<ul className="space-y-1 list-disc ml-6">
  <li>Perform high-quality CPR for adults, children, and infants</li>
  <li>Use Automated External Defibrillators (AEDs) safely and effectively</li>
  <li>Respond to choking and breathing emergencies</li>
  <li>Apply the correct sequence of life-saving actions in emergencies</li>
</ul>

<p>
  The course combines practical, hands-on training with guided instruction to ensure participants develop confidence and competence in real-life emergency situations.
</p>

<p>
  Delivered by experienced and certified instructors, the training emphasises clarity, repetition, and real-world application — ensuring that every participant leaves ready to act when it matters most.
</p>

<p>
  This course is ideal for healthcare workers, first responders, teachers, fitness trainers, caregivers, corporate teams, and members of the public who want to be prepared to save lives in everyday environments.
</p>
