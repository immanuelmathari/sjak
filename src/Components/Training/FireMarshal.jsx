...
const accordionData = [
  {
    title: "Why Fire Marshal Training is Important",
    content:
      "Fire emergencies can develop rapidly and without warning. Having trained Fire Marshals ensures that there are individuals on-site who can take immediate control, reduce panic, and implement safety procedures. This training helps prevent fires, protects lives, and minimises damage to property and operations.",
  },
  {
    title: "Who Should Attend",
    content:
      "This course is ideal for employees designated as Fire Marshals, safety officers, facility managers, security personnel, and organisational leaders. It is essential for any organisation that prioritises safety and compliance with fire safety regulations.",
  },
  {
    title: "What You Will Learn",
    content:
      "Participants will learn fire prevention techniques, types of fires and extinguishers, safe evacuation procedures, emergency planning, and how to respond effectively during a fire incident. The training includes hands-on practice with firefighting equipment and real-life scenario simulations.",
  },
  {
    title: "Course Duration and Delivery",
    content:
      "The Fire Marshal Training is conducted over three days, providing an in-depth and practical learning experience. It can be delivered at St John Ambulance Kenya training facilities or on-site at your organisation, tailored to your specific environment and risks.",
  },
  {
    title: "Role of a Fire Marshal in an Emergency",
    content:
      "A Fire Marshal is responsible for raising the alarm, guiding people to safety, ensuring evacuation procedures are followed, and using firefighting equipment where safe to do so. They act as leaders during emergencies, helping maintain order and ensuring no one is left behind.",
  },
  {
    title: "Why You Should Choose St John Ambulance Kenya",
    content:
      "St John Ambulance Kenya is a trusted leader in emergency training with years of experience in saving lives and building safer communities. Our trainers are highly qualified, our programmes are practical and internationally aligned, and our approach ensures participants leave with real, applicable skills. Choosing St John means investing in quality, reliability, and proven expertise.",
  },
];
...
Fire Marshal Course With St John Ambulance Kenya
</h1>
...
<section className="bg-white dark:bg-black py-12 md:py-20">
  <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
    ...
    <p>
  The Fire Marshal Training Course offered by St John Ambulance Kenya is a comprehensive programme designed to equip individuals with the knowledge and practical skills required to prevent, manage, and respond to fire emergencies in the workplace and community.
</p>

<p>
  Fires can escalate within seconds, causing devastating loss of life and property. A trained Fire Marshal plays a critical role in ensuring safety by identifying risks, leading evacuations, and taking immediate action before emergency services arrive.
</p>

<ul className="space-y-1 list-disc ml-6">
  <li>Identify fire hazards and implement prevention measures</li>
  <li>Lead safe and organised evacuations during emergencies</li>
  <li>Use fire extinguishers and firefighting equipment correctly</li>
  <li>Respond quickly and effectively to fire incidents</li>
</ul>

<p>
  This 3-day training can be conducted at St John Ambulance Kenya facilities or delivered on-site at your organisation, ensuring flexibility and relevance to your working environment.
</p>

<p>
  At St John Ambulance Kenya, we bring decades of experience in emergency response and training. Our certified instructors combine real-world expertise with practical, hands-on teaching methods to ensure every participant gains confidence and competence.
</p>

<p>
  Choosing St John means training with one of the most trusted humanitarian organisations, known for delivering high-quality, globally aligned safety training that organisations and individuals rely on.
</p>
        ...
        <div className="max-w-4xl mb-10">
          ...
          <div className="bg-yellow-500 inline-block px-4 py-2">
            <h2 className="text-3xl font-bold text-black leading-snug capitalize">
              Importance of First Marshal Course
            </h2>
          </div>
