...
const accordionData = [
  {
    title: "Why LifeSaver International First Aid Training is Important",
    content:
      "Emergencies can occur anywhere, and the ability to respond effectively can make the difference between life and death. This course equips participants with advanced first aid knowledge and practical skills aligned with international standards, ensuring readiness in diverse and high-pressure situations.",
  },
  {
    title: "Who Should Attend",
    content:
      "This course is suitable for individuals, corporate teams, safety officers, volunteers, and anyone seeking comprehensive first aid training. It is especially valuable for organisations that require globally recognised standards of safety and emergency preparedness.",
  },
  {
    title: "What You Will Learn",
    content:
      "Participants will gain in-depth knowledge and hands-on experience in CPR, use of automated external defibrillators (AEDs), management of bleeding and shock, fractures, burns, choking, and emergency scene management. The training emphasises practical application and critical thinking in real-life scenarios.",
  },
  {
    title: "Course Duration and Structure",
    content:
      "The LifeSaver International First Aid Course runs over three days, providing an immersive learning experience that balances theory and practical sessions. The structured format ensures participants fully understand and can apply life-saving techniques with confidence.",
  },
  {
    title: "Benefits for Individuals and Organisations",
    content:
      "For individuals, the course builds confidence, competence, and the ability to respond effectively in emergencies. For organisations, it strengthens workplace safety, supports compliance with health and safety standards, and demonstrates a strong commitment to employee wellbeing and risk management.",
  },
];
...
const LifeSaverInternationalFirstAid = () => {
...
Life Saver International First Aid With St John Ambulance Kenya
</h1>
  ...
  <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
    ...
    <div>
      ...
      <div className="space-y-4 text-gray-600 dark:text-gray-300 text-base md:text-lg">
        ...
        <p>
  The LifeSaver International First Aid Course offered by St John Ambulance Kenya is an intensive, globally aligned training programme designed to equip participants with comprehensive life-saving skills for a wide range of emergency situations.
</p>

<p>
  Delivered over three days, this course combines practical, hands-on training with internationally recognised first aid standards, ensuring participants are prepared to respond confidently both locally and in global environments.
</p>

<ul className="space-y-1 list-disc ml-6">
  <li>Comprehensive first aid and emergency response training</li>
  <li>Hands-on practice in real-life emergency scenarios</li>
  <li>Training aligned with international St John standards</li>
  <li>Development of confidence, leadership, and decision-making under pressure</li>
</ul>

<p>
  Participants are guided by certified and experienced trainers who ensure that each individual gains both theoretical knowledge and practical competence in handling emergencies effectively.
</p>

<p>
  This course is ideal for individuals, workplace teams, and organisations seeking a higher level of preparedness and internationally benchmarked first aid capability.
</p>
...
export default LifeSaverInternationalFirstAid;
