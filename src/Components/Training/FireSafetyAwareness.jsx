...
const accordionData = [
  {
    title: "Why Fire Safety Awareness is Important",
    content:
      "Many fires are caused by preventable factors such as electrical faults, poor handling of equipment, or lack of awareness. Fire safety awareness equips individuals with the knowledge to identify risks early and take simple steps to prevent incidents before they occur.",
  },
  {
    title: "Who Should Book This Programme",
    content:
      "This programme is ideal for companies, schools, churches, community groups, and residential facilities. It is especially valuable for organisations looking to build a safety-conscious culture among staff, students, and members.",
  },
  {
    title: "What You Will Learn",
    content:
      "Participants will learn how fires start, common hazards to watch out for, basic prevention techniques, and simple actions to take in case of a fire. The focus is on awareness, understanding, and immediate response rather than technical firefighting.",
  },
  {
    title: "How the Programme is Delivered",
    content:
      "St John Ambulance Kenya delivers this awareness programme on-site at your location. Sessions are interactive, engaging, and tailored to your environment, ensuring participants can relate the knowledge directly to their daily surroundings.",
  },
  {
    title: "How to Respond in a Fire Situation",
    content:
      "Participants are guided on key steps: stay calm, raise the alarm, avoid panic, evacuate safely, and assist others where possible. Emphasis is placed on awareness, quick thinking, and prioritising safety at all times.",
  },
  {
    title: "Why You Should Book This Programme",
    content:
      "Fire safety awareness is one of the simplest and most effective ways to prevent disasters. By educating your people, you create a safer environment, reduce risks, and build confidence in handling emergencies. It is a proactive step that shows responsibility and care for the wellbeing of everyone in your organisation or community.",
  },
];



const FireSafetyAwareness = () => {
...
Fire Safety Awareness Course With St John Ambulance Kenya
</h1>
...
<section className="bg-white dark:bg-black py-12 md:py-20">
  <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
   ...
   <p>
  The Fire Safety Awareness Programme by St John Ambulance Kenya is designed to educate individuals and groups on how to prevent fires, recognise risks, and respond safely in case of a fire emergency.
</p>

<p>
  Many fire incidents can be avoided with the right knowledge and awareness. In homes, schools, workplaces, and community settings, understanding fire risks and knowing how to act can make a critical difference in protecting lives and property.
</p>

<ul className="space-y-1 list-disc ml-6">
  <li>Understand common fire hazards in everyday environments</li>
  <li>Learn simple and effective fire prevention practices</li>
  <li>Recognise early warning signs of fire خطر</li>
  <li>Know what to do immediately in case of a fire emergency</li>
</ul>

<p>
  This programme is delivered at your premises, making it accessible and relevant to your specific environment. Our trainers engage participants through practical demonstrations, discussions, and real-life examples.
</p>

<p>
  Fire safety awareness is not about technical training — it is about building a culture of alertness, responsibility, and preparedness among people in your organisation or community.
</p>

<p>
  With St John Ambulance Kenya, you benefit from experienced trainers who understand real emergency situations and deliver training that is simple, practical, and impactful.
</p>
...
export default FireSafetyAwareness;
