...
const accordionData = [
  {
    title: "Why Disaster Preparedness Training is Important",
    content:
      "Emergencies and disasters can occur without warning. Being unprepared can lead to loss of life, severe injuries, and significant property damage. Disaster preparedness training equips individuals and organisations to anticipate risks, respond safely, and mitigate the impact of emergencies.",
  },
  {
    title: "Who Should Attend",
    content:
      "This course is ideal for corporate teams, community leaders, schools, churches, government agencies, and individuals who want to enhance their disaster response readiness. Any organisation or group that operates in environments prone to emergencies will benefit from this training.",
  },
  {
    title: "What You Will Learn",
    content:
      "Participants will learn how to identify hazards, create and implement emergency response plans, conduct risk assessments, manage casualties, perform basic first aid during disasters, and coordinate effective evacuation procedures. Training includes practical drills for realistic scenarios.",
  },
  {
    title: "Course Duration and Structure",
    content:
      "The Disaster Preparedness and Response Course is conducted over two to three days depending on the depth required. Training combines theory with practical exercises, role plays, and emergency simulations to ensure full preparedness for various disaster scenarios.",
  },
  {
    title: "How to Respond in a Disaster",
    content:
      "Participants are trained to stay calm, assess the situation quickly, prioritise life-threatening risks, and coordinate resources and people efficiently. Emphasis is placed on leadership, communication, and critical decision-making under pressure.",
  },
  {
    title: "Benefits for Individuals and Organisations",
    content:
      "For individuals, the course develops confidence, resilience, and the ability to respond safely and effectively. For organisations and communities, it enhances safety culture, ensures legal and ethical compliance, protects assets, and reduces the impact of disasters.",
  },
  {
    title: "Why You Should Choose St John Ambulance Kenya",
    content:
      "St John Ambulance Kenya has decades of experience in emergency preparedness and disaster response. Our trainers are certified experts who combine global best practices with practical experience. Choosing St John ensures that you receive high-quality, hands-on training that prepares you to act decisively and save lives when every second counts.",
  },
];



const DisasterPreparednessAndResponse = () => {
...
Disaster Preparedness and Response Course With St John Ambulance Kenya
</h1>
...
<section className="bg-white dark:bg-black py-12 md:py-20">
  <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
   ...
   <p>
  The Disaster Preparedness and Response Course by St John Ambulance Kenya is a comprehensive training programme designed to equip organisations, communities, and individuals with the knowledge and practical skills to anticipate, respond to, and recover from emergencies and disasters effectively.
</p>

<p>
  Disasters can strike unexpectedly — from floods, fires, and accidents to large-scale emergencies. The ability to respond quickly and correctly can save lives, protect property, and reduce operational disruption. This course ensures that participants are prepared to act confidently when seconds matter.
</p>

<ul className="space-y-1 list-disc ml-6">
  <li>Identify potential disaster risks and hazards within your environment</li>
  <li>Develop practical emergency response and evacuation plans</li>
  <li>Learn lifesaving techniques to manage casualties and critical incidents</li>
  <li>Build resilience for your organisation or community during and after a disaster</li>
</ul>

<p>
  Training can be conducted at St John Ambulance Kenya facilities or on-site at your location, tailored to your environment and the specific risks you may face. Our approach emphasises realistic scenario-based exercises for hands-on learning.
</p>

<p>
  Participants are trained by highly qualified and experienced instructors who have delivered disaster response programmes across multiple sectors. The course combines practical drills, scenario simulations, and strategic planning, ensuring that participants can respond effectively in real-life emergencies.
</p>

<p>
  Upon successful completion, participants receive certification, demonstrating their preparedness and your organisation’s commitment to safety and disaster resilience. With St John Ambulance Kenya, you are not just trained — you are ready to act when it matters most.
</p>
        ...
        <div className="max-w-4xl mb-10">
          ...
          <div className="bg-yellow-500 inline-block px-4 py-2">
            <h2 className="text-3xl font-bold text-black leading-snug capitalize">
              Importance of Disaster Preparedness And Response Course
            </h2>
          </div>
...
export default DisasterPreparednessAndResponse;
