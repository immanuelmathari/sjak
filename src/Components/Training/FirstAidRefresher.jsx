...
const accordionData = [
  {
    title: "Why First Aid Refresher Training is Important",
    content:
      "First aid skills can fade over time if not regularly practiced. Refresher training ensures that individuals retain critical knowledge, stay updated with the latest guidelines, and maintain the ability to respond quickly and effectively during emergencies.",
  },
  {
    title: "Who Should Attend",
    content:
      "This course is ideal for previously trained first aiders, workplace safety personnel, volunteers, and anyone whose certification requires renewal. It is especially beneficial for organisations that prioritize continuous safety and preparedness.",
  },
  {
    title: "What You Will Learn",
    content:
      "Participants will revisit essential skills such as CPR, management of bleeding, handling fractures, burns, choking, and emergency scene assessment. The training emphasizes practical application to ensure readiness in real-life situations.",
  },
  {
    title: "Course Duration and Location",
    content:
      "The refresher course is conducted over 1 to 2 days at St John House, Parliament Road. The schedule is designed to be intensive yet flexible, allowing participants to efficiently update their skills without extended time away from work.",
  },
  {
    title: "Benefits for Individuals and Organisations",
    content:
      "For individuals, the course restores confidence and sharpens life-saving abilities. For organisations, it ensures compliance with safety standards, reduces workplace risks, and demonstrates a continued commitment to employee wellbeing.",
  },
];
  ...
  <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
    ...
    <div>
      ...
      <div className="space-y-4 text-gray-600 dark:text-gray-300 text-base md:text-lg">
        ...
        <p>
  The First Aid Refresher Course at St John Ambulance Kenya is designed to reinforce and update previously acquired first aid skills, ensuring that individuals remain confident, competent, and ready to respond effectively in emergencies.
</p>

<p>
  Conducted at our headquarters at St John House along Parliament Road, this hands-on training revisits critical life-saving techniques while incorporating updated best practices in emergency response.
</p>

<ul className="space-y-1 list-disc ml-6">
  <li>Refresh essential first aid knowledge and practical skills</li>
  <li>Stay up to date with current emergency response guidelines</li>
  <li>Improve confidence and speed when handling real-life incidents</li>
  <li>Reinforce correct techniques through guided practical sessions</li>
</ul>

<p>
  The course typically runs for 1 to 2 days, making it ideal for individuals and organisations looking to maintain high safety standards without long training commitments.
</p>

<p>
  Whether you are a certified first aider, workplace safety officer, or volunteer, this refresher training ensures you remain prepared to save lives when it matters most.
</p>
...
export default FirstAidRefresher;
